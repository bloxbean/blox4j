...
public class ContractTest {
    ...
    public static void contractTest(IAionAPI api, ApiMsg apiMsg) {
        ...
        Address account = AionAddress.wrap("a0c0cc973a306d31320fe72cad62afaa799d076bbd492ca4d5d5d941adfa12a9");
...
// print result
    ...
    public static void sendTransaction(IAionAPI api, ApiMsg apiMsg) {
        ...
        TxArgs txArgs = new TxArgs.TxArgsBuilder()
                .from(AionAddress.wrap("a0c0cc973a306d31320fe72cad62afaa799d076bbd492ca4d5d5d941adfa12a9"))
                .to(AionAddress.wrap("a0ee03368d08281ab8d4a0bc70768b25e9363b80b060291b0e045cf763c0d817"))
    ...
    public static void invokeMethod(IAionAPI api, ApiMsg apiMsg) throws InterruptedException {
        ...
        Address ownerAddress = AionAddress.wrap("a0c0cc973a306d31320fe72cad62afaa799d076bbd492ca4d5d5d941adfa12a9");
        Address contractAddress = AionAddress.wrap("a0325401995789edf2287def289d3c6d93c9e0771b47209104cfa1b722f0c9cc");
...
// contract address and the ABI definition
    ...
    public static void getMethod1(IAionAPI api, ApiMsg apiMsg) throws InterruptedException {
        ...
        Address ownerAddress = AionAddress.wrap("a0c0cc973a306d31320fe72cad62afaa799d076bbd492ca4d5d5d941adfa12a9");
        Address contractAddress = AionAddress.wrap("a0c8ffc3275734f35f5567552c144bbe4a77e0dba4f75b209ecf9ffe0b2a4646");
