...
import com.bloxbean.bloxql.impl.aion.util.AbiUtil;
...
import com.bloxbean.bloxql.impl.aion.util.ContractTypeConverter;
import com.bloxbean.bloxql.model.*;
...
import static com.bloxbean.bloxql.impl.aion.util.ContractTypeConverter.populateInputParams;
import static com.bloxbean.bloxql.impl.aion.util.ContractTypeConverter.populateOutputs;
...
public class ContractServiceImpl implements ContractService {
        ...
        return accessor.call(((apiMsg, api) -> {
            ...
            try {
                ...
                if (params == null || params.size() == 0) {
                    if (value != null)
                        apiMsg.set(api.getContractController().createFromSource(source, AionAddress.wrap(from), nrgLimit, nrgPrice, value));
                    else
                        apiMsg.set(api.getContractController().createFromSource(source, AionAddress.wrap(from), nrgLimit, nrgPrice));

                } else {

                    List<ISolidityArg> solParams = ContractTypeConverter.convertParamsToSolValues(params);
                    apiMsg.set(api.getContractController().createFromSource(source, AionAddress.wrap(from), nrgLimit, nrgPrice, value, solParams));
                }
    ...
    public List<ContractBean> createMultiContractsFromSource​(String source, String from, long nrgLimit, long nrgPrice, BigInteger value, List<ConstructorArgs> constructorArgsList) {
        ...
        return accessor.call(((apiMsg, api) -> {
            ...
            try {
                ...
                apiMsg.set(api.getContractController().createFromSource(source, AionAddress.wrap(from), nrgLimit, nrgPrice, value, argsMap));
    ...
    public ContractResponseBean execute(String fromAddress, String contractAddress, String abiDefinition,
        ...
        return accessor.call(((apiMsg, api) -> {
            ...
            try {
                IContract contract = api.getContractController().getContractAt(AionAddress.wrap(fromAddress), AionAddress.wrap(contractAddress),
                        abiDefinition);
...
//                    throw new BlockChainAcessException("Invalid function or function definition not found in abi");
    ...
    public List<ContractEventBean> getContractEvents(String ownerAddress, String contractAddress, String abiDefinition, List<String> events, ContractEventFilterBean eventFilterBean,
        ...
        return accessor.call(((apiMsg, api) -> {
            ...
            try {
                IContract contract = api.getContractController().getContractAt(AionAddress.wrap(ownerAddress), AionAddress.wrap(contractAddress),
                        abiDefinition);
    ...
    public List<?> call(TxArgsInput txArgsInput, String abiFunction, List<Output> outputTypes) {
        ...
        Function function = Function.fromJSON(jsonObject);
