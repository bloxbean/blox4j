...
import com.bloxbean.bloxql.impl.aion.util.TypeUtil;
import com.bloxbean.bloxql.model.*;
...
public class TxnServiceImpl implements TxnService {
    ...
    public List<com.bloxbean.bloxql.model.TxDetails> getTransactions(long before, long first) {
        List<com.bloxbean.bloxql.model.TxDetails> transactions = new ArrayList<com.bloxbean.bloxql.model.TxDetails>();
    ...
    public com.bloxbean.bloxql.model.TxDetails getTransaction(String txHash) {
        if (logger.isDebugEnabled())
...
//            return block;
    ...
    @Override
    public List<com.bloxbean.bloxql.model.TxDetails> getTransactionsByHash(List<String> txHashes) {
        if (logger.isDebugEnabled())
        ...
        List<com.bloxbean.bloxql.model.TxDetails> txDetails = new ArrayList<>();
        return accessor.call(((apiMsg, api) -> {
            ...
            for(String txHash: txHashes) {
                ...
                Transaction transaction = apiMsg.getObject();
                com.bloxbean.bloxql.model.TxDetails txDetail = ModelConverter.convert(transaction);
    ...
    public byte[] callBytes(TxArgsInput args) { //Needed for internal calls
        ...
        return accessor.call(((apiMsg, api) -> {
            ...
            TxArgs txArgs = new TxArgs.TxArgsBuilder()
                .from(AionAddress.wrap(args.getFrom()))
                .to(AionAddress.wrap(args.getTo()))
                .value(args.getValue())
                .nonce(args.getNonce())
        ...
        return accessor.call(((apiMsg, api) -> {
            ...
            for(CompileResponse compRes: compileResponses.values()) {
                ...
                ContractDeploy.ContractDeployBuilder contractDeployBuilder
                        ...
                        .from(AionAddress.wrap(cd.getFrom()))
    ...
    public boolean eventDeregister(List<String> evts, String address) {
        ...
        return accessor.call(((apiMsg, api) -> {
            apiMsg.set(api.getTx().eventDeregister(evts, AionAddress.wrap(address)));
    ...
    public boolean eventRegister(List<String> evts, ContractEventFilterBean ef, String address) {
        ...
        return accessor.call(((apiMsg, api) -> {
            apiMsg.set(api.getTx().eventRegister(evts, cef, AionAddress.wrap(address)));
    ...
    public String getCode(String address) {
        ...
        return accessor.call(((apiMsg, api) -> {
            apiMsg.set(api.getTx().getCode(AionAddress.wrap(address)));
    ...
    public String getCode(String address, long blockNumber) {
        ...
        return accessor.call(((apiMsg, api) -> {
            apiMsg.set(api.getTx().getCode(AionAddress.wrap(address), blockNumber));
